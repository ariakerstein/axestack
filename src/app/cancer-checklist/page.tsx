          ...
          <div className="flex items-center gap-3">
            ...
            {profile && profile.cancerType && (
              <span className="hidden sm:inline text-xs bg-violet-100 text-violet-700 px-2 py-1 rounded-full">
                {CANCER_TYPES[profile.cancerType]}
              </span>
            )}
            ...
            <ShareButton
              tool="checklist"
              title="Share Cancer Checklist"
              description="Help others prepare for their appointments"
              variant="icon"
            />
          </div>
        </div>
...
- Clinical trial interest"
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className={`font-medium ${item?.checked ? 'text-emerald-700 line-through' : 'text-slate-900'}`}>
                            {test.name}
                          </p>
                          ...
                          {isEditing ? (
                            <div className="mt-2 flex gap-2">
                              <input
                                ...
                                className="flex-1 px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent"
                                autoFocus
                                onKeyDown={(e) => {
                            ...
                            <button
                              onClick={(e) => startEditNote(test.name, e)}
                              className="mt-2 text-xs text-slate-400 hover:text-violet-600 flex items-center gap-1"
                            >
                        ...
                        <button
                          ...
                          className="text-violet-400 hover:text-violet-600 flex-shrink-0 mt-1"
                        >
                          →
                        </button>
                      </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className={`font-medium flex items-center gap-2 ${item?.checked ? 'text-emerald-700 line-through' : 'text-slate-900'}`}>
                              {test.name}
                              {test.urgency && (
                            ...
                            {isEditing ? (
                              <div className="mt-2 flex gap-2">
                                <input
                                  ...
                                  className="flex-1 px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-violet-500"
                                  autoFocus
                                  onKeyDown={(e) => {
                                    if (e.key === 'Enter') saveNote(test.name)
                                    if (e.key === 'Escape') cancelEditNote()
                                ...
                                />
                                <button onClick={() => saveNote(test.name)} className="px-3 py-2 bg-violet-600 text-white rounded-lg text-sm">
                                  <Save className="w-4 h-4" />
                                </button>
            ...
            <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-6 text-center mt-6">
              ...
              <a
                ...
                className="inline-block bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-400 hover:to-purple-400 text-white font-semibold px-6 py-3 rounded-xl transition-all hover:scale-105"
              >
