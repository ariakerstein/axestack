      ...
      <div className="max-w-3xl mx-auto px-8 py-16">
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 mb-12">
          <img
            src="/ari.png"
            alt="Ari Akerstein"
            className="w-32 h-32 rounded-2xl object-cover shadow-lg ring-2 ring-slate-200"
          />
          <div>
            <h1 className="text-4xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-slate-500 to-slate-500">Ari Akerstein</h1>
            <p className="text-xl text-slate-600 mb-4">Building tools for people who don't have time to waste.</p>
            <div className="flex gap-4">
              <a href="https://linkedin.com/in/ariakerstein" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href="https://x.com/aakerstein" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://github.com/ariakerstein" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors">
              ...
              <a href="https://www.ariakerstein.com/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors" title="Field Notes">
        ...
        <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 mb-12">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-orange-600 hover:bg-orange-500 text-white font-medium rounded-lg transition-colors"
                >
                  Read online →
                </a>
                <a
                  ...
                  download
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 border border-slate-300 hover:border-slate-400 text-slate-700 hover:text-slate-600 font-medium rounded-lg transition-colors"
                >
                  Download PDF
                </a>
              </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-block bg-gradient-to-r from-slate-600 to-slate-600 hover:from-slate-500 hover:to-slate-500 text-white font-semibold px-6 py-3 rounded-xl transition-all hover:scale-105"
            >
              Email Me
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block border border-slate-300 hover:border-slate-400 text-slate-700 hover:text-slate-600 font-semibold px-6 py-3 rounded-xl transition-all"
            >
              Connect on LinkedIn
            </a>
          </div>
